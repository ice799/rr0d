...
#define isidstart(c) ( isalpha(c) || (c)=='_' || (c)=='.' || (c)=='?'  || (c)=='@' )
                                  
#define isidchar(c)  ( isidstart(c) || isdigit(c) || (c)=='$' || (c)=='#'   || (c)=='~' )
...
struct ofmt {
     ...
     */
         ...
         /***** OJO MODIFICACION DEL TEXTO ORIGINAL
                YA QUE UTILIZA DEFINES DE STDIO.H  *******/
